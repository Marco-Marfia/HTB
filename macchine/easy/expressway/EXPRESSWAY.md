...
![nmap -sVC 10.10.11.87](./immagini/1-porte_tcp.png)
...
![nmap -sU -F -T4 10.10.11.87](./immagini/2porte_udp.png)
...
![sudo --version](./immagini/6.1-sudo_version.png)

![searchsploit 1.9.17](./immagini/6.2-file_52352.png)
